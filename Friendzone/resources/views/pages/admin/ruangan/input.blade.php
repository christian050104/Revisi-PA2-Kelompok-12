        ...
        <div class="side-app">
            <div class="main-container container-fluid">
                <div class="row row-sm">
                    ...
                    <form id="form_input"method="post" action="{{ route('admin.ruangan.store') }}">
                        @csrf
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-3">
                            ...
                            <div class="card-footer">
                                <div class="hstack gap-2 justify-content-end">
                                    ...
                                    @if($data->id)
                                    <button id="tombol_simpan" onclick="handle_upload('#tombol_simpan','#form_input','{{route('admin.ruangan.update',$data->id)}}','PATCH');" class="btn btn-primary" id="add-btn">Edit Meja</button>
                                    @else
                                    <button id="tombol_simpan" onclick="handle_upload('#tombol_simpan','#form_input','{{route('admin.ruangan.store')}}','POST');" class="btn btn-primary" id="add-btn">Tambah Meja</button>
                                    @endif
                                </div>
                            </div>
                        </div>
