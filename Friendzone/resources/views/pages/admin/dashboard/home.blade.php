                                                ...
                                                <div>
                                                    ...
                                                    <div class="most-ordered-product">
                                                        ...
                                                        @if ($mostOrderedProduct)
                                                            <p>Nama Produk: <span
                                                                    style="font-weight: bold;">{{ $mostOrderedProduct->title }}</span>
                                                            </p>
                                                            <p>Jumlah Pembelian: <span
                                                                    style="font-weight: bold;">{{ $mostOrderedProduct->order_details_count }}</span>
                                                            </p>
                                                        @else
            ...
            <script>
                ...
                var chart = new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            label: 'Pendapatan',
                            data: [{{ $januarySum }}, {{ $februarySum }}, {{ $maretSum }},
                                {{ $aprilSum }}, {{ $meiSum }}, {{ $juneSum }},
                                {{ $julySum }}, {{ $augustSum }}, {{ $septemberSum }},
