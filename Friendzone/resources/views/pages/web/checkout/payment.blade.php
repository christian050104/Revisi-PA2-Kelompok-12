...
.black-text {
        color: #000 !important; /* Warna font hitam pekat */
    }

    </style>
    <div class="bread-crumb">
		<img src="{{ asset('assets/images/7.jpeg') }}" class="img-responsive" alt="banner-top" title="banner-top">
		<div class="container">
			<div class="matter">
				<h2>Pembayaran</h2>
				<ul class="list-inline">
					<li><a href="{{ (url('/')) }}">Beranda</a></li>
					<li><a href="{{ url('/daftarmenu') }}">Pembayaran</a></li>
				</ul>
			</div>
		</div>
	</div>
                ...
                <form method="POST" id="form" enctype="multipart/form-data" action="{{ route('web.checkout') }}">
                    <div class="tab-pane col-md-12 col-sm-12 col-xs-12" id="tab-payment">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                <input class="form-control black-text" id="input-cardnumber" placeholder="Nomor Kartu" name="payment" required="" type="text" readonly>
                            </div>
                            
                            <div class="form-group">
                                <label for="input-proof">Bukti Pembayaran</label>
                                <input name="image" id="image" class="form-control black-text" type="file" {{ (old('payment') != 'Cash') ? 'required' : '' }}>
                            </div>
                        </fieldset>
