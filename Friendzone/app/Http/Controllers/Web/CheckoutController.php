...
class CheckoutController extends Controller
{
    ...
    public function checkout(Request $request)
    {
        ...
        if ($request->payment == 'Dana (Kesya | 89508085763649474)' || $request->payment == 'Mandiri (Dian | 1052013280147)' || $request->payment == 'BNI (Felix Aldi | 1437234627)') {
            $validators = Validator::make($request->all(), [
    ...
    {
        return view('pages.web.checkout.show', compact('order'));
    }
}
